...
export function FavouriteCoinsModal() {
  ...
  const tokens: Token[] = [
    ...
    { icon: '/assets/images/waifu.png', name: 'SOL', price: 0.04837, volume: 2.4, change: -3.1, isFavorite: true },
    { icon: '/assets/images/waifu.png', name: 'USDC', price: 0.04837, volume: 2.4, change: 67, isFavorite: true },
    { icon: '/assets/images/waifu.png', name: 'FARTCOIN', price: 0.04837, volume: 2.4, change: 1.33, isFavorite: true },
    { icon: '/assets/images/waifu.png', name: 'WAIFU', price: 0.04837, volume: 2.4, change: 1.33, isFavorite: true },
    { icon: '/assets/images/waifu.png', name: 'SOL', price: 0.04837, volume: 2.4, change: -3.1, isFavorite: true },
    { icon: '/assets/images/waifu.png', name: 'USDC', price: 0.04837, volume: 2.4, change: 67, isFavorite: true },
    { icon: '/assets/images/waifu.png', name: 'FARTCOIN', price: 0.04837, volume: 2.4, change: 1.33, isFavorite: true },
    ...
    <Win95Modal title="LEADERBOARDS" onClose={closeModal}>
      <div className="bg-[#FDFAD1] text-black flex flex-col h-full relative">
        <div className="flex flex-col gap-0">
          <span className="text-4xl md:text-7xl leading-none text-center text-[#1E1A33]">FAVOURITE</span>
          <span className="text-5xl md:text-8xl leading-none text-center text-[#1E1A33]">COINS</span>
        </div>
