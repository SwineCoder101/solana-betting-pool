...
const SolanabettingapplicationFeature = lazy(() => import('../components/solanabettingapplication/solanabettingapplication-feature'))
const DashboardFeature = lazy(() => import('../components/dashboard/dashboard-feature'))

const links: { label: string; path: string }[] = [
  { label: 'Account', path: '/account' },
  { label: 'Clusters', path: '/clusters' },
  { label: 'Solanabettingapplication Program', path: '/solanabettingapplication' },
]
